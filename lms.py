...
st.set_page_config(
    page_title="Personal Library Manager",  # Corrected page title
    page_icon="📖",
    layout="wide",
    ...
    with st.form(key='add_book_form'):
        ...
        with col2:
            genre = st.selectbox("Genre", [
                "Friction", "Life spending", "Technology", "cycle", "physics", "History", "Al Khalaq", "IbHaitam", "Science", "Poetry", "Art", "WriteZoology"
             ])
...
# Footer
st.markdown("---")
st.markdown("© 2025 Programming with Abdullah | Library Management System", unsafe_allow_html=True)
